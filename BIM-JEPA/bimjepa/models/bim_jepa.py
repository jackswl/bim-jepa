...
from bimjepa.modules.EMA import EMA
from bimjepa.modules.context_sampler import ContextSampler
from bimjepa.modules.masking import PointcloudMasking
...
from bimjepa.modules.transformer import (
    TransformerEncoder,
...
class BimJepa(pl.LightningModule):
    def __init__(
        self,
